...
def main(dataset,gt_pair_poses_file,predict_pair_poses_file):
    ...
    for idx in range(0,len(gt_pair_poses)):
        ...
        predict_trans = predict_pair_poses[idx,:].reshape(3,4)
...
if __name__=='__main__':
    ...
    main("kitti","/home/zuosibo/NewDisk/loop_data/loop_poses/distance_based/kitti/08.txt","/home/zuosibo/SGLC_ws（fujian）/out/kitti/08_poses.txt")